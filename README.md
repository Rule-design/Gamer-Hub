...
La versión para PC puede mostrar una advertencia de Windows SmartScreen porque la aplicación no está firmada digitalmente. Para ejecutarla, haga clic en "Más información" → "Ejecutar de todos modos".
